# Example re issue https://github.com/sirk390/wxasync/issues/2
# Shows how StartCoroutine() works but custom event binding to async method fails.
# app is created before frame architecture.
#
# update - now it works, solution is not to specify id when you AsyncBind
