...
def runTest(frame, nb, log):
    ...
    ed.SetText(demoText + open(r"C:\Program Files\wxPython2.8 Docs and Demos\demo\Main.py").read())
    ed.EmptyUndoBuffer()
    ed.Colourise(0, -1)
...
if __name__ == "__main__":
    ...
    class MyApp(wx.App):
        def OnInit(self):
            ...
            frame2.SetWindowStyleFlag(
                wx.DEFAULT_DIALOG_STYLE
            )  # wx.FRAME_FLOAT_ON_PARENT) #wx.DEFAULT_FRAME_STYLE | wx.FRAME_TOOL_WINDOW | wx.FRAME_FLOAT_ON_PARENT) #wx.STAY_ON_TOP |
            self.SetTopWindow(frame)
