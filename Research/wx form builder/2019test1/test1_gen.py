...
class MyFrame1(wx.Frame):
    def __init__(self, parent):
        ...
        self.btn_showpopup = wx.Button(
            self, wx.ID_ANY, "POPUP FRAME", wx.DefaultPosition, wx.DefaultSize, 0
        )
        bSizer5.Add(self.btn_showpopup, 0, wx.ALL, 5)

        self.m_button2 = wx.Button(
            self, wx.ID_ANY, "popup html", wx.DefaultPosition, wx.DefaultSize, 0
        )
        ...
        self.m_button5 = wx.Button(
            sbSizer1.GetStaticBox(), wx.ID_ANY, "MyButton", wx.DefaultPosition, wx.DefaultSize, 0
        )
        ...
        self.m_button12 = wx.Button(
            self.m_panel1, wx.ID_ANY, "MyButton", wx.DefaultPosition, wx.DefaultSize, 0
        )
...
class MyMenuBar1(wx.MenuBar):
    def __init__(self):
        ...
        self.m_menuItem5 = wx.MenuItem(
            self.m_menu2, wx.ID_ANY, "MyMenuItem", wx.EmptyString, wx.ITEM_NORMAL
        )
...
class MyToolBar1(wx.ToolBar):
    def __init__(self, parent):
        ...
        self.m_checkBox1 = wx.CheckBox(
            self, wx.ID_ANY, "Check Me!", wx.DefaultPosition, wx.DefaultSize, 0
        )
        self.AddControl(self.m_checkBox1)
        m_comboBox1Choices = []
        self.m_comboBox1 = wx.ComboBox(
            self, wx.ID_ANY, "Combo!", wx.DefaultPosition, wx.DefaultSize, m_comboBox1Choices, 0
        )
        self.AddControl(self.m_comboBox1)
        self.m_bpButton1 = wx.BitmapButton(
            self, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW | 0
        )
        ...
        self.m_button21 = wx.Button(
            self, wx.ID_ANY, "feeling", wx.DefaultPosition, wx.DefaultSize, 0
        )
...
class MyFrame2(wx.Frame):
    def __init__(self, parent):
        ...
        self.m_button30 = wx.Button(
            self.m_scrolledWindow1, wx.ID_ANY, "MyButton", wx.DefaultPosition, wx.DefaultSize, 0
        )
