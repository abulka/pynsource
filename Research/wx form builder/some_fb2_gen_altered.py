...
class MyFrame1 ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = wx.EmptyString, pos = wx.DefaultPosition, size = wx.Size( 557,361 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
...
class MyFrame2 ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		from someStyledTextCtrl2 import PythonSTC																	  # ANDY
		#self.m_panel1 = wx.Panel( self.m_notebook1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL ) # ANDY
		self.m_panel1 = PythonSTC(self.m_notebook1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL) # ANDY
		bSizer4 = wx.BoxSizer( wx.VERTICAL )
		
		# WARNING: wxPython code generation isn't supported for this widget yet.
		#self.m_scintilla1 = wx.Window( self.m_panel1 )  # ANDY
		self.m_scintilla1 = self.m_panel1				 # ANDY
...
class MyFrame3 ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_mgr.AddPane( self.m_textCtrl1, wx.aui.AuiPaneInfo() .Left() .CaptionVisible( False ).MaximizeButton( False ).MinimizeButton( False ).PinButton( True ).Dock().Resizable().FloatingSize( wx.DefaultSize ).DockFixed( False ).CentrePane() )
