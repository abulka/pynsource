...
class MyFrame1(wx.Frame):
    def __init__(self, parent):
        ...
        self.m_htmlWin1 = wx.html.HtmlWindow(
            self.m_panel1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.html.HW_SCROLLBAR_AUTO
        )
        ...
        self.m_button5 = wx.Button(
            self.m_panel6, wx.ID_ANY, "MyButton", wx.DefaultPosition, wx.DefaultSize, 0
        )
        ...
        self.m_searchCtrl1 = wx.SearchCtrl(
            self.m_panel6, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0
        )
        ...
        self.m_splitter1 = wx.SplitterWindow(
            ...
            wx.DefaultPosition,
            wx.DefaultSize,
            wx.SP_3D | wx.SP_3DBORDER | wx.SP_BORDER,
        )
        ...
        self.m_button1 = wx.Button(
            self.m_panel4, wx.ID_ANY, "Load Html", wx.DefaultPosition, wx.DefaultSize, 0
        )
        bSizer2.Add(self.m_button1, 0, wx.ALL | wx.EXPAND, 5)

        self.m_button2 = wx.Button(
            self.m_panel4, wx.ID_ANY, "Load Html 2", wx.DefaultPosition, wx.DefaultSize, 0
        )
        ...
        self.m_scrolledWindow1.SetBackgroundColour(
