...
class DrawFrame(wx.Frame):
    ...
    def __init__(self, parent, id, title, position, size):
        ...
        help_menu = wx.Menu()
        help_menu.Append(ID_ABOUT_MENU, "&About", "More information About this program")
        ...
        self.Canvas = NavCanvas.NavCanvas(
            self, -1, (500, 500), Debug=0, BackgroundColor="DARK SLATE BLUE"
        ).Canvas
    ...
    def Setup(self, event=None):
        ...
        for i, color in enumerate(("LightBlue", "Green", "Purple", "Yellow")):
            ...
            Poly = self.Canvas.AddPolygon(
                points, LineWidth=2, LineColor="Black", FillColor=color, FillStyle="Solid"
            )
    ...
    def SelectPoly(self, Object):
        ...
        if Object is self.SelectedPolyOrig:
            ...
            self.SelectedPoly = Canvas.AddPolygon(
                Object.Points,
                LineWidth=2,
                LineColor="Red",
                FillColor="Red",
            ...
            self.SelectedPoints = Canvas.AddPointSet(
                Object.Points, Diameter=6, Color="Red", InForeground=True
            )
