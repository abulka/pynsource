...
class HexMvcGuiFrame1(wx.Frame):
    def __init__(self, parent):
        ...
        self.m_menuItem1 = wx.MenuItem(
            self.m_menu1, wx.ID_ANY, "New", wx.EmptyString, wx.ITEM_NORMAL
        )
        self.m_menu1.AppendItem(self.m_menuItem1)

        self.m_menuItem2 = wx.MenuItem(
            self.m_menu1, wx.ID_ANY, "Load", wx.EmptyString, wx.ITEM_NORMAL
        )
        self.m_menu1.AppendItem(self.m_menuItem2)

        self.m_menuItem3 = wx.MenuItem(
            self.m_menu1, wx.ID_ANY, "Save", wx.EmptyString, wx.ITEM_NORMAL
        )
        ...
        self.m_button3 = wx.Button(
            self.m_panel1, wx.ID_ANY, "Dump Model", wx.DefaultPosition, wx.DefaultSize, 0
        )
        bSizer3.Add(self.m_button3, 0, wx.ALL, 5)

        self.m_button9 = wx.Button(
            self.m_panel1, wx.ID_ANY, "Clear", wx.DefaultPosition, wx.DefaultSize, 0
        )
        bSizer3.Add(self.m_button9, 0, wx.ALL, 5)

        self.m_button4 = wx.Button(
            self.m_panel1, wx.ID_ANY, "Add Junk Text", wx.DefaultPosition, wx.DefaultSize, 0
        )
        bSizer3.Add(self.m_button4, 0, wx.ALL, 5)

        self.m_button5 = wx.Button(
            self.m_panel1, wx.ID_ANY, "MessageBox", wx.DefaultPosition, wx.DefaultSize, 0
        )
        ...
        self.m_button11 = wx.Button(
            self.m_panel1, wx.ID_ANY, "Background Task 1", wx.DefaultPosition, wx.DefaultSize, 0
        )
        bSizer5.Add(self.m_button11, 0, wx.ALL, 5)

        self.m_button12 = wx.Button(
            self.m_panel1, wx.ID_ANY, "Stop", wx.DefaultPosition, wx.DefaultSize, 0
        )
        bSizer5.Add(self.m_button12, 0, wx.ALL, 5)

        self.m_gauge1 = wx.Gauge(
            self.m_panel1, wx.ID_ANY, 100, wx.DefaultPosition, wx.DefaultSize, wx.GA_HORIZONTAL
        )
        ...
        self.m_button6 = wx.Button(
            self.m_panel1, wx.ID_ANY, "New", wx.DefaultPosition, wx.DefaultSize, 0
        )
        bSizer4.Add(self.m_button6, 0, wx.ALL, 5)

        self.m_button7 = wx.Button(
            self.m_panel1, wx.ID_ANY, "Load", wx.DefaultPosition, wx.DefaultSize, 0
        )
        bSizer4.Add(self.m_button7, 0, wx.ALL, 5)

        self.m_button8 = wx.Button(
            self.m_panel1, wx.ID_ANY, "Save", wx.DefaultPosition, wx.DefaultSize, 0
        )
        ...
        self.m_listBox1 = wx.ListBox(
            self.m_panel1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, m_listBox1Choices, 0
        )
        ...
        self.m_button1 = wx.Button(
            self.m_panel1, wx.ID_ANY, "Add Thing", wx.DefaultPosition, wx.DefaultSize, 0
        )
        bSizer2.Add(self.m_button1, 0, wx.ALL, 5)

        self.m_button2 = wx.Button(
            self.m_panel1, wx.ID_ANY, "Delete Thing", wx.DefaultPosition, wx.DefaultSize, 0
        )
        bSizer2.Add(self.m_button2, 0, wx.ALL, 5)

        self.m_button121 = wx.Button(
            self.m_panel1, wx.ID_ANY, "Add Info To Thing", wx.DefaultPosition, wx.DefaultSize, 0
        )
        ...
        self.m_hyperlink3 = wx.HyperlinkCtrl(
            self.m_panel1,
            wx.ID_ANY,
            "/hello",
            "http://www.wxformbuilder.org",
        ...
        self.m_hyperlink4 = wx.HyperlinkCtrl(
            self.m_panel1,
            wx.ID_ANY,
            "/hello/man",
            "http://www.wxformbuilder.org",
        ...
        self.m_hyperlink5 = wx.HyperlinkCtrl(
            self.m_panel1,
            wx.ID_ANY,
            "/ajax",
            "http://www.wxformbuilder.org",
        ...
        self.m_hyperlink6 = wx.HyperlinkCtrl(
            self.m_panel1,
            wx.ID_ANY,
            "/ajax_info1",
            "http://www.wxformbuilder.org",
        ...
        self.m_hyperlink8 = wx.HyperlinkCtrl(
            self.m_panel1,
            wx.ID_ANY,
            "/xml",
            "http://www.wxformbuilder.org",
