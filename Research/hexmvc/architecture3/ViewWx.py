...
class GuiFrame(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(
            ...
            parent,
            id=wx.ID_ANY,
            title="HexMvc Architecture 3 Gui",
            pos=wx.DefaultPosition,
            size=wx.Size(500, 439),
        ...
        self.m_menuItem1FileNew = wx.MenuItem(
        ...
        self.m_button12 = wx.Button(
            self, wx.ID_ANY, "New / Clear", wx.DefaultPosition, wx.DefaultSize, 0
        )
        ...
        self.m_textCtrlDump = wx.TextCtrl(
        ...
        self.m_button11 = wx.Button(
            self, wx.ID_ANY, "Dump Model", wx.DefaultPosition, wx.DefaultSize, 0
        )
        ...
        self.m_button122 = wx.Button(
            self, wx.ID_ANY, "Add Thing", wx.DefaultPosition, wx.DefaultSize, 0
        )
        ...
        self.m_button121 = wx.Button(
            self, wx.ID_ANY, "Add Info to Thing", wx.DefaultPosition, wx.DefaultSize, 0
        )
        bSizer101AddInfo.Add(self.m_button121, 0, wx.ALL, 5)

        self.inputFieldTxtZ = wx.TextCtrl(
            self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0
        )
        ...
        self.m_button131 = wx.Button(
            self, wx.ID_ANY, "Delete Thing", wx.DefaultPosition, wx.DefaultSize, 0
        )
