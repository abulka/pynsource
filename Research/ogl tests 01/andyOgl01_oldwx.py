...
class TestWindow(wxShapeCanvas):
    def __init__(self, parent, log, frame):
        ...
        self.MyAddShape(
            wxRectangleShape(85, 50), 305, 60, wxBLACK_PEN, wxLIGHT_GREY_BRUSH, "Rectangle"
        )
        ds = self.MyAddShape(DividedShape(140, 150, self), 495, 145, wxBLACK_PEN, dsBrush, "")
        self.MyAddShape(
            DiamondShape(90, 90), 345, 235, wxPen(wxBLUE, 3, wxDOT), wxRED_BRUSH, "Polygon"
        )
        self.MyAddShape(
            RoundedRectangleShape(95, 70), 140, 255, wxPen(wxRED, 2), rRectBrush, "Rounded Rect"
        )
