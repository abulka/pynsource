...
** 2019 News: For an exciting new, online version of pynsource, please email abulka@gmail.com and
...
Version 1.71 (Feb 2019)
- new, faster diagramming engine
- zoom in and out
- drag UML lines to connect shapes
- modify UML lines between shapes, CMD R shortcut to reverse direction
- print - page setup, allows printing to A3 etc. and changing to landscape etc.
- print - 1...9999 range bug fixed (still displays that range but won't actually print it)
