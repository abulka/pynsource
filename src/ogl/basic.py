    ...
    def OnDraw(self, dc):
        ...
        if self._shadowMode != SHADOW_NONE:
            ...
            if self._cornerRadius:
                dc.DrawRoundedRectangle(int(x1 + self._shadowOffsetX), int(y1 + self._shadowOffsetY), int(self._width), int(self._height), int(self._cornerRadius)) # python 3.10 needs ints - missing fix in official release!
            else:
                dc.DrawRectangle(int(x1 + self._shadowOffsetX), int(y1 + self._shadowOffsetY), int(self._width), int(self._height)) # python 3.10 needs ints - missing fix in official release!
        ...
        if self._cornerRadius:
            dc.DrawRoundedRectangle(int(x1), int(y1), int(self._width), int(self._height), int(self._cornerRadius)) # python 3.10 needs ints - missing fix in official release!
        else:
            dc.DrawRectangle(int(x1), int(y1), int(self._width), int(self._height)) # python 3.10 needs ints - missing fix in official release!
