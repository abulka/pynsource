...
class FrameDeepLayout(wx.Frame):
    def __init__(self, parent):
        ...
        self.m_gauge1 = wx.Gauge(
            self, wx.ID_ANY, 4, wx.DefaultPosition, wx.DefaultSize, wx.GA_HORIZONTAL
        )
        ...
        self.m_staticText3.SetFont(
            wx.Font(
                8, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, "Tahoma"
            )
        )
