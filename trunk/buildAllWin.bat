...
"c:\Program Files\7-Zip"\7z a -tzip  -xr!".svn" -xr!"build" -xr!"dist" -xr!"java-ide-import-results" -xr!*.pyc dist\%outsourcezip% src\* tests\* setup.py Readme.txt rungui.bat runtests.bat build.txt
...
cd ..
:step3a
"c:\Program Files\7-Zip"\7z a -tzip  dist\%outstandalonezip% .\src\dist\* .\Readme.txt .\build.txt
