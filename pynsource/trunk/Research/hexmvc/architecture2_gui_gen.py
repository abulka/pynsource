...
class GuiFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_mgr.AddPane( self.m_panel1, wx.aui.AuiPaneInfo() .Left() .CloseButton( False ).PinButton( True ).Dock().Resizable().FloatingSize( wx.DefaultSize ).CentrePane() )
		...
		self.inputFieldTxt = wx.TextCtrl( self.m_panel1, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer2.Add( self.inputFieldTxt, 0, wx.ALL, 5 )
		...
		self.m_hyperlink2 = wx.HyperlinkCtrl( self.m_panel1, wx.ID_ANY, u"/modelsize", u"http://www.wxformbuilder.org", wx.DefaultPosition, wx.DefaultSize, wx.HL_DEFAULT_STYLE )
		bSizer8.Add( self.m_hyperlink2, 0, wx.ALL, 5 )
		
		self.m_hyperlink3 = wx.HyperlinkCtrl( self.m_panel1, wx.ID_ANY, u"/dumpthings", u"http://www.wxformbuilder.org", wx.DefaultPosition, wx.DefaultSize, wx.HL_DEFAULT_STYLE )
		...
		# Connect Events
		self.Bind( wx.EVT_MENU, self.OnFileNew, id = self.m_menuItem1.GetId() )
